...
Una vez obtenidos los distintos datasets se juntaron basandose en dos columnas distintas, según el caso podía ser el ``ISO`` o el ``nombre`` de un país.
Con frecuencia la ortografía de un país variaba de uno a otro, los pasos que seguí fueron:  
...
```{r Gráfico Inflación, echo=FALSE}
...
```{r Gráfico CPI, echo=FALSE, warning=FALSE}
...
```{r Gráfico Correlación Inflación CPI, echo=FALSE, warning=FALSE}
